...
job_cloud_handler1 = CloudLoggingHandler(on_gce=True, logname=executor1.subname)
executor1.job_log.addHandler(job_cloud_handler1)
...
executor2.job_log.addHandler(job_cloud_handler2)
executor2.job_log.addHandler(ch)
executor2.job_log.setLevel(logging.DEBUG)

tasks = [executor1, executor2]
